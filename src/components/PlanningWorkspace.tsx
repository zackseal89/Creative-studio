    ...
    return (
      <div className="bg-[#0F0F0F] border border-[#222] rounded-none p-8 flex flex-col items-center justify-center h-full min-h-[400px]">
        ...
        <div className="text-center mt-4">
          ...
          <p className="text-zinc-400 text-[10px] font-mono uppercase tracking-widest mt-1">Arranging facts, hooks, and milestones</p>
        </div>
      </div>
    );
  }
  ...
  if (!plan) {
    return (
      <div className="bg-[#0F0F0F] border border-[#222] rounded-none p-8 flex flex-col items-center justify-center text-center h-full min-h-[400px]">
        ...
        <p className="text-zinc-400 text-[11px] mt-2 max-w-sm leading-relaxed">
  ...
  return (
    <div className="bg-[#0F0F0F] border border-[#222] rounded-none overflow-hidden flex flex-col h-full shadow-sm">
      ...
      <div className="bg-[#0A0A0A] px-6 py-4 border-b border-[#222] flex items-center justify-between">
        ...
        <span className="text-[9px] bg-[#1A1A1A] px-2 py-0.5 rounded-sm border border-[#222] text-[#F27D26] font-bold uppercase tracking-widest animate-pulse">
          HUMAN APPROVED FLOW
        </span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin select-text">
        ...
        <div className="space-y-2">
          <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-[#F27D26]">
            ...
            <div key={index} className="bg-[#0A0A0A] border border-[#222] rounded-none p-4.5 space-y-3.5 shadow-sm">
              ...
              <div>
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#111] border border-[#222] hover:border-[#333] focus:border-[#F27D26] rounded-none p-3 text-xs text-zinc-200 font-sans leading-relaxed outline-none transition-all scrollbar-thin"
      ...
      <div className="bg-[#0A0A0A] px-6 py-4 border-t border-[#222] flex items-center justify-between gap-4">
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-3 bg-[#1A1A1A] border border-[#333] hover:border-zinc-400 hover:text-white text-zinc-300 rounded-none text-[10px] uppercase font-bold tracking-widest transition-all disabled:opacity-50 cursor-pointer"
        >
